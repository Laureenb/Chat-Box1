...
echo "Créer un serveur par groupe et le faire communiquer avec les autres pc's du groupe.

Créer un site multipage en MVC avec un system de account et de chatBox le tout en DB

Créer un user (qui n'exi
ste pas encore avec un mot de passe (non crypter pour commencer))
